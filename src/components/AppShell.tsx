      ...
      return (
        <div className="mx-auto flex h-14 w-full items-center justify-between px-4 sm:h-16">
          ...
          <div className="flex items-center gap-4 text-slate-400">
            {toggleTheme && (
              <button onClick={toggleTheme} className="hover:text-white transition text-xs font-mono font-bold" aria-label="Toggle theme">
                {theme === 'dark' ? '☀️' : '🌙'}
              </button>
            )}
      ...
      return (
        <div className="mx-auto flex h-14 w-full items-center justify-between px-4 sm:h-16">
          ...
          <div className="flex items-center gap-4">
            {toggleTheme && (
              <button onClick={toggleTheme} className="text-slate-400 hover:text-white transition text-xs font-mono font-bold" aria-label="Toggle theme">
                {theme === 'dark' ? '☀️' : '🌙'}
              </button>
            )}
